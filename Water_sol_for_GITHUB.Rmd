...
Acidity_AR_S$Layer <- gsub("2 No", "2", Acidity_AR_S$Layer)
Acidity_AR_S$Layer <- gsub("2 Yes", "2", Acidity_AR_S$Layer)
...
cor.test(Sulfur[Sulfur$Layer == "3 Incubated",]$Acidity, Sulfur[Sulfur$Layer == "3 Incubated",]$Sulfur, method = "spearman")
cor.test(Sulfur[Sulfur$Layer == "2 Incubated",]$Acidity, Sulfur[Sulfur$Layer == "2 Incubated",]$Sulfur, method = "spearman")
cor.test(Sulfur[Sulfur$Layer == "2 Non-inc",]$Acidity, Sulfur[Sulfur$Layer == "2 Non-inc",]$Sulfur, method = "spearman")
cor.test(Sulfur[Sulfur$Layer == "1 Non-inc",]$Acidity, Sulfur[Sulfur$Layer == "1 Non-inc",]$Sulfur, method = "spearman")
...
Water_sol_selected[Water_sol_selected$Layer == "1 No",]
#ALL correlations
...
Aqua_select <- Geochemistry2B_Aqua[-c(1,2,201:223),-c(1,2,4,7,8,51:57)]
